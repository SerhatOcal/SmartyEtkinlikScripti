...
<script>
    $(document).ready(function() {
        ...
        $('.toggle_check').change(function() {
           ...
           $.post(base_url + "admin/isActiveSetterActivity", {id: id, isActive: isActive}, function (response) {
           });
        ...
        $( ".sortableList" ).on("sortupdate", function (event, ui) {
            ...
            $.post(base_url +"admin/activityRankUpdate" ,{data:data}, function (response) {
            });
        });
    });
