        ...
        <div class="col-md-12">
            ...
            <div class="panel-heading panel-heading-transparent">
                ...
                <div class="panel-body">
                    <form class="myform" method="post" enctype="multipart/form-data" action="<?php echo base_url("admin/add_training"); ?>">

                       <div class="form-group col-md-6">
                            <label>Başlık</label>
                            <input type="text" name="title" value="" class="form-control required" placeholder="Bu kayıt için bir başlık giriniz.">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="feature" value="" class="form-control required" placeholder="Özellik,Özellik1,Özellik2">
                        </div>

                        <div class="form-group col-md-12">
                            <label>Eğitim ile ilgili Önemli Bilgi</label>
                            <input type="text" name="information" value="" class="form-control required" placeholder="Eğitimle ilgili çok önemli bir bilgi yazın.">
                        </div>

                        <div class="form-group col-md-12">
                            <label>Keyword (Aralarına virgül koyarak yazınız.)</label>
                            <input type="text" name="keyword" value="" class="form-control required" placeholder="Keyword,Keyword1,Keyword2">
                        </div>
