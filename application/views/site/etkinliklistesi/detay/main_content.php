<section class="padding-20">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-8 margin-bottom-30 height-250"><?php echo $activity_trainings->bride_detail;?></div>
      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body padding-5">
          <h3 class="text-center margin-bottom-0"><?php echo get_full_date_from_full_date($activitys->start_date)." - ". get_day_from_eng(date("D"));?></h3>
        </div>
      </div>
      </div>
